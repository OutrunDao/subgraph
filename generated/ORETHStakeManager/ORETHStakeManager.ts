...
export class StakeORETH extends ethereum.Event {
  get params(): StakeORETH__Params {
    return new StakeORETH__Params(this);
  }
}

export class StakeORETH__Params {
  _event: StakeORETH;

  constructor(event: StakeORETH) {
    this._event = event;
  }
  ...
  get amountInORETH(): BigInt {
    return this._event.parameters[2].value.toBigInt();
  }

  get amountInOSETH(): BigInt {
    return this._event.parameters[3].value.toBigInt();
  }
...
export class ORETHStakeManager__positionsOfResultValue0Struct extends ethereum.Tuple {
  get orETHAmount(): BigInt {
    return this[0].toBigInt();
  }

  get osETHAmount(): BigInt {
...
export class ORETHStakeManager__stakeResult {
  value0: BigInt;
  value1: BigInt;
...
export class ORETHStakeManager extends ethereum.SmartContract {
  static bind(address: Address): ORETHStakeManager {
    return new ORETHStakeManager("ORETHStakeManager", address);
  }
  ...
  ORETH(): Address {
    let result = super.call("ORETH", "ORETH():(address)", []);

    return result[0].toAddress();
  }

  try_ORETH(): ethereum.CallResult<Address> {
    let result = super.tryCall("ORETH", "ORETH():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  OSETH(): Address {
    let result = super.call("OSETH", "OSETH():(address)", []);

    return result[0].toAddress();
  }

  try_OSETH(): ethereum.CallResult<Address> {
    let result = super.tryCall("OSETH", "OSETH():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  calcOSETHAmount(amountInORETH: BigInt): BigInt {
    let result = super.call(
      "calcOSETHAmount",
      "calcOSETHAmount(uint256):(uint256)",
  ...
  try_calcOSETHAmount(amountInORETH: BigInt): ethereum.CallResult<BigInt> {
  ...
  getStakedORETH(): BigInt {
    let result = super.call("getStakedORETH", "getStakedORETH():(uint256)", []);

    return result[0].toBigInt();
  }

  try_getStakedORETH(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getStakedORETH",
      "getStakedORETH():(uint256)",
      [],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  positionsOf(
    positionId: BigInt,
  ): ORETHStakeManager__positionsOfResultValue0Struct {
    let result = super.call(
      "positionsOf",
    ...
    return changetype<ORETHStakeManager__positionsOfResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_positionsOf(
    positionId: BigInt,
  ): ethereum.CallResult<ORETHStakeManager__positionsOfResultValue0Struct> {
    let result = super.tryCall(
      "positionsOf",
      "positionsOf(uint256):((uint104,uint104,uint40,bool,address))",
      [ethereum.Value.fromUnsignedBigInt(positionId)],
    ...
    return ethereum.CallResult.fromValue(
      changetype<ORETHStakeManager__positionsOfResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
  ...
  stake(
    ...
    osETHTo: Address,
    reyTo: Address,
  ): ORETHStakeManager__stakeResult {
    let result = super.call(
      "stake",
      ...
      [
        ...
        ethereum.Value.fromAddress(osETHTo),
        ethereum.Value.fromAddress(reyTo),
      ],
    );

    return new ORETHStakeManager__stakeResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_stake(
    ...
    osETHTo: Address,
    reyTo: Address,
  ): ethereum.CallResult<ORETHStakeManager__stakeResult> {
    let result = super.tryCall(
      "stake",
      "stake(uint256,uint16,address,address,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ORETHStakeManager__stakeResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
