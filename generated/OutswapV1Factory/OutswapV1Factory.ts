...
export class OutswapV1Factory extends ethereum.SmartContract {
  static bind(address: Address): OutswapV1Factory {
    return new OutswapV1Factory("OutswapV1Factory", address);
  }
